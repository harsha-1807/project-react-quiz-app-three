...
const Third = () => {
  ...
  return (
    <div style={{ backgroundColor:"#3B2F7F", display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100vw', height: '100vh', justifyContent: 'center' }}>
      <div className='resultPage' style={{ backgroundColor: 'white', color: 'black', width: '50%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
        ...
        <div className='decide' style={{ marginBottom: '20px' }}>
          ...
          <button style={{ marginRight: '30px', backgroundColor:"#3B2F7F",}}>TRY AGAIN</button>
          </Link>
          <Link to='/'>
            <button style={{backgroundColor:"#007100"}}>HOME</button>
          </Link>
        </div>
      </div>
    </div>
